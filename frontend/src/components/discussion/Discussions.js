...
export default function Discussions(props) {
    return (
        <div className='discussions container space-y-2 flex flex-col justify-center items-center mx-auto w-auto'>    
            {props.children}
        </div>
    );
}

export function Discussion({username, avatar, content, date, topics}) {
    ...
    return (
        <div className='discussion container rounded-md border-2 border-gray-300 w-1/2'>
            ...
            <div className='discussion-content p-3 text-lg'>
                <p>{content ?? 'This is a placeholder discussion.'}</p>
            </div>
